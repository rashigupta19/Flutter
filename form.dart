  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Material(
          color: Color.fromARGB(0, 247, 245, 245),
          child: SafeArea(
            child: Padding(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: const BorderSide(
                              color: Color.fromARGB(255, 101, 233, 30),
                              width: 2,
                            ),
                            borderRadius: BorderRadius.circular(50),
                          ),
                          errorBorder: OutlineInputBorder(
                            borderSide: const BorderSide(
                              color: Color.fromARGB(255, 12, 218, 8),
                              width: 2,
                            ),
                            borderRadius: BorderRadius.circular(50),
                          ),
                          focusedErrorBorder: OutlineInputBorder(
                            borderSide: const BorderSide(
                              color: Color.fromARGB(255, 9, 224, 31),
                              width: 2,
                            ),
                            borderRadius: BorderRadius.circular(50),
                          ),
                      ...
                      TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            enabledBorder: OutlineInputBorder(
                              borderSide: const BorderSide(
                                color: Color.fromARGB(255, 30, 233, 30),
                                width: 2,
                              ),
                              borderRadius: BorderRadius.circular(50),
                            ),
                      ...
                      DropdownButtonFormField<String>(
                          ...
                          decoration: InputDecoration(
                            ...
                            enabledBorder: OutlineInputBorder(
                              borderSide: const BorderSide(
                                color: Color.fromARGB(255, 30, 233, 81),
                                width: 2,
                              ),
                              borderRadius: BorderRadius.circular(50),
                            ),
                      ...
                      RawMaterialButton(
                        fillColor: Color.fromARGB(255, 30, 233, 44),
